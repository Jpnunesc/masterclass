  ...
  template: `
    <section class="mc-container mc-stack tokens-root">
      ...
      <div class="section">
        ...
        <div class="type-grid">
          <div><span class="mc-display-xl">Aa</span><code>--mc-fs-display-xl</code></div>
          <div><span class="mc-display-lg">Aa</span><code>--mc-fs-display-lg</code></div>
          <div><span class="mc-display-md">Aa</span><code>--mc-fs-display-md</code></div>
          <div><span class="mc-display-sm">Aa</span><code>--mc-fs-display-sm</code></div>
